...
/// <summary>
/// Controls the orientation of content place by the <see cref="PlaceOnPlane"/>
...
public class RotationController : MonoBehaviour
{
    ...
    float angle
    {
        get
        {
            return placeOnPlane.rotation.eulerAngles.y;
        }
        set
        {
            placeOnPlane.rotation = Quaternion.AngleAxis(value, Vector3.up);
            UpdateText();
        }
    }
